...
class Leads(SyncAPIResource):
    ...
    def update(
        ...
        id: str,
        *,
        personalization: str | None | NotGiven = NOT_GIVEN,
        website: str | None | NotGiven = NOT_GIVEN,
        last_name: str | None | NotGiven = NOT_GIVEN,
        first_name: str | None | NotGiven = NOT_GIVEN,
        company_name: str | None | NotGiven = NOT_GIVEN,
        job_title: str | None | NotGiven = NOT_GIVEN,
        phone: str | None | NotGiven = NOT_GIVEN,
